    ...
    >
      <Show when={shown()}>
        <div class="<sm:max-h-10em max-h-14em overflow-y-auto">
          ...
          <SettingItem icon="i-carbon:api" label="粘贴你的APIKey">
            <input
              type="password"
          ...
          <SettingItem icon="i-carbon:user-online" label="指定角色预设">
            <input
              type="text"
      ...
      <div class="mt-2 flex items-center justify-between">
        ...
        >
          <button class="i-carbon:settings" title="设置" />
...
async function exportJpg() {
  ...
  async function downloadIMG() {
    ...
    a.href = url
    a.download = `AI-${dateFormat(new Date(), "HH-MM-SS")}.jpg`
    a.click()
  }
